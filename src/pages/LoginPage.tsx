...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#0f1015] flex items-center justify-center p-4 relative font-sans">
      {/* Background glow to match landing page vibe */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none flex items-center justify-center">
        <div className="w-[600px] h-[500px] bg-orange-500/10 blur-[120px] rounded-full" />
      </div>
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[14px] text-gray-400">Sign in to SyncStudy</p>
        </div>
        ...
        <form className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex justify-end mt-2.5">
              <a href="#" className="text-[12px] text-[#ff8c37] hover:underline font-medium">
                Forgot password?
              </a>
            </div>
          </div>
        ...
        <p className="text-center text-[13px] text-gray-500 mt-8 font-medium">
          ...
          <Link to="/register" className="text-[#ff8c37] font-bold hover:underline">
            Sign up free
          </Link>
        </p>
      </motion.div>
